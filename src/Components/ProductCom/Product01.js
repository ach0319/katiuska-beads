        ...
        <div className="row g-0 justify-content-center align-items-center">
            ...
            <div className="col-md-8 " >
                <div className="card-body text-white">
                    <h5 className="card-title fs-4 text-center">OLBR Bracelet</h5>
                    <p className="card-text fs-5 text-center">Description: 6MM OLIVE COLOR GEMSTONE BEADS AND 8 MM BROWN GEMSTOWN BEADS</p>
                ...
                <div className="email-button">
                   <a className="btn btn-primary buy-button" href="https://buy.stripe.com/cN23cz1WP4J8d3OdQQ">Purchase Now</a>
                </div>
