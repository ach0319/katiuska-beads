        ...
        <div className="row g-0 justify-content-center align-items-center">
            ...
            <div className="col-md-8 " >
                <div className="card-body text-white">
                    <h5 className="card-title fs-4 text-center">PIEV Bracelet</h5>
                    <p className="card-text fs-5 text-center">Description: BEAUTIFUL PINK 6MM CRYSTAL BEADS AND PINK 8MM STONE BEADS WITH AN EVIL EYE HANGING CHARM</p>
