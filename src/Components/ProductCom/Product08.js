        ...
        <div className="row g-0 justify-content-center align-items-center">
            ...
            <div className="col-md-8 " >
                <div className="card-body text-white">
                    <h5 className="card-title fs-1 text-center">Bracelet GRGRW</h5>
                    <p className="card-text fs-3 text-center">Description: 3MM Green/Gold/Red and White Beads</p>
                ...
                <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                    ...
                    <input type="hidden" name="hosted_button_id" value="L3BJMPJF6XTX2"/>
