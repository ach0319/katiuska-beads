        ...
        <div className="row g-0 justify-content-center align-items-center">
            ...
            <div className="col-md-8 " >
                <div className="card-body text-white">
                    <h5 className="card-title fs-1 text-center">NAWH KID Bracelet</h5>
                    <p className="card-text fs-3 text-center">Description: KIDS BRACELET; 3MM NAVY BLUE AND WHITE BEADS</p>
