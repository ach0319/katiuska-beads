        ...
        <div className="row g-0 justify-content-center align-items-center">
            ...
            <div className="col-md-8 " >
                <div className="card-body text-white">
                    <h5 className="card-title fs-4 text-center"> CRYS Charm Bracelet</h5>
                    <p className="card-text fs-5 text-center">Description: 2 SILVER CHARMS AND 1 GOLDISH BLUE CHARM WITH 3 SETS OF CRYSTAL BEADS HANGING </p>
                    <h5 className="card-price fs-4 text-center">$11.00</h5>
                </div>
                <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                    <input type="hidden" name="cmd" value="_s-xclick"/>
                    <input type="hidden" name="hosted_button_id" value="A93QB9N7L522G"/>
