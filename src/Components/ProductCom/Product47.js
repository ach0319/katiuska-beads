        ...
        <div className="row g-0 justify-content-center align-items-center">
            ...
            <div className="col-md-8 " >
                <div className="card-body text-white">
                    <h5 className="card-title fs-1 text-center">UNI Head Beads</h5>
                    <p className="card-text fs-3 text-center">Description: UNISEX Head Beads, Multicolor 4mm beads</p>
                    <p className="card-text fs-3 text-center"><small class="text-black">Size: 22 inches</small></p>
                    <h5 className="card-price fs-1 text-center">$15.00</h5>
                </div>
                <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                    <input type="hidden" name="cmd" value="_s-xclick"/>
                    <input type="hidden" name="hosted_button_id" value="UDGLZCCG8NTKC"/>
