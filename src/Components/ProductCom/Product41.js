        ...
        <div className="row g-0 justify-content-center align-items-center">
            ...
            <div className="col-md-8 " >
                <div className="card-body text-white">
                    <h5 className="card-title fs-4 text-center">PUGR Earrings</h5>
                    <p className="card-text fs-5 text-center">Description: PURPLE AND GREY STONE WITH ORANGE CRYSTALS, 6MM BEADS</p>
                ...
                <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                    ...
                    <input type="hidden" name="hosted_button_id" value="ANNKDJ7YGQ6ZN"/>
